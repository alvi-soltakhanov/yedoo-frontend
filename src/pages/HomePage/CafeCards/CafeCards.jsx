  ...
  return (
    <>
      ...
      <div className={styles.cafeOverflow}>
        <div
          className={`${styles.cafeContainer} ${
            cafe ? styles.showCafe : styles.hideCafe
          }`}
        >
          {!cafe
            ? ""
      ...
      <div className={styles.moreBlock}>
        <button
          onClick={() => handleMore(someCafe + 4)}
          className={`${styles.moreBtn} ${
            someCafe >= cafe?.length ? styles.hide : ""
          }`}
        >
          Показать больше
        </button>
        <button
          onClick={() => handleMore(4)}
          className={`${styles.moreBtn} ${someCafe === 4 ? styles.hide : ""}`}
        >
          Скрыть
        </button>
      </div>
