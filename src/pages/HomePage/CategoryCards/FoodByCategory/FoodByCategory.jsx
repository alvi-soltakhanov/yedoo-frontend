            ...
            {!food || !(categoryLength) ? '' :
                <>
                    ...
                    <div className={styles.moreBlock}>
                        <button onClick={() => handleFoodCount(foodCount + 4)} className={`${styles.moreBtn} ${foodCount >= foodArr.length ? styles.hide : ''}`}>Показать больше</button>
                        <button onClick={() => handleFoodCount(4)} className={`${styles.moreBtn} ${foodCount === 4 ? styles.hide : ''}`}>Скрыть</button>
                    </div>
